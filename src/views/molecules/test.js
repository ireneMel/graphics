...
// //     'plot3d_collection', 'ms3drender' // render of multiple surfaces
// // ], function ($, _, util, msg, graphAddonsTpl,
// //              TablePlotUi, Mathpar3d, Plot3dImplicit,
// //              Plot3dExplicit, Plot3dParametric, Plot3dCollection, RenderMultipleSurfaces) {
// //     'use strict';
// //
// //     var
...
// //         this.isPlot3dCollection = task.indexOf('\\showPlots3D') >= 0;
// //         this.isPlot3dCollectionIntersection = task.indexOf('\\intersection3D') >= 0;
// //         if (this.isPlot3dCollectionIntersection) {
// //             task = task.replace('\\intersection3D', '\\showPlots3D');
// //             this.isPlot3dCollection = true;
// //         }
...
// //             this.isPlot3dCollection || this.isPlot3dCollectionIntersection || this.isRenderMultipleSurfaces);
...
// //             this.mathpar3d.init();
// //         }
// //         this.graphImg.removeClass('threed');
// //
// //         if (this.isPlot3dImplicit && !this.isPlot3dCollection) {
// //             this.plot3dImplicit = new Plot3dImplicit(this.sectionId, this.graphImg);
// //         }
// //         if (this.isPlot3dExplicit && this.isRenderMultipleSurfaces === false && !this.isPlot3dCollection) {
// //             this.plot3dExplicit = new Plot3dExplicit(this.sectionId, this.graphImg);
// //         }
// //         if (this.isPlot3dParametric && this.isRenderMultipleSurfaces === false && !this.isPlot3dCollection) {
// //             this.plot3dParametric = new Plot3dParametric(this.sectionId, this.graphImg);
// //         }
// //         if (this.isPlot3dCollection && this.isRenderMultipleSurfaces === false) {
// //             this.plot3dCollection = new Plot3dCollection(this.sectionId, this.graphImg, this.isPlot3dCollectionIntersection)
// //         }
// //
...
//     // fix if height 0
//     // @TODO
//     /*if (this.graphImg.width() === 0 || this.graphImg.height() === 0) {
//       this.graphImg.height(1024);
//       this.graphImg.width(1024);
//     }*/
//
//     this.graphImg.removeClass('threed');
//
